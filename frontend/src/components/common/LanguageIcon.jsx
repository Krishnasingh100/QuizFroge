  ...
  const icons = {
    ...
    c: (
      <svg {...commonProps}>
        ...
        <text x="32" y="43" textAnchor="middle" fontFamily="'Trebuchet MS', Arial, sans-serif" fontWeight="700" fontSize="30" fill="#00599C">C</text>
      </svg>
    ),

    // C++ — official isocpp blue/navy gradient rounded diamond
    cpp: (
      <svg {...commonProps}>
        <defs>
        ...
        <path d="M32 4 56 18v28L32 60 8 46V18L32 4Z" fill="url(#cppGrad)" />
        <text x="26" y="41" textAnchor="middle" fontFamily="Arial, sans-serif" fontWeight="700" fontSize="19" fill="#fff">C</text>
    ...
    javascript: (
      <svg {...commonProps}>
        ...
        <text x="34" y="46" textAnchor="middle" fontFamily="Arial, sans-serif" fontWeight="700" fontSize="26" fill="#000">JS</text>
      </svg>
    ),
    ...
    typescript: (
      <svg {...commonProps}>
        ...
        <text x="34" y="46" textAnchor="middle" fontFamily="Arial, sans-serif" fontWeight="700" fontSize="26" fill="#fff">TS</text>
      </svg>
    ),
    ...
    java: (
      <svg {...commonProps}>
        ...
        <path d="M24 12c-2 2 2 3 0 5s-4 4 0 6" fill="none" stroke="#EA2D2E" strokeWidth="2" strokeLinecap="round" />
        <path d="M31 10c-2 2 2 3 0 5s-4 4 0 6" fill="none" stroke="#EA2D2E" strokeWidth="2" strokeLinecap="round" />
        <path d="M18 30h26c1 5-1 12-13 12S17 35 18 30Z" fill="#5382A1" />
        <path d="M44 32c4-1 7 1 7 4s-3 5-8 4" fill="none" stroke="#5382A1" strokeWidth="2.5" />
        <path d="M22 46c-3 2-3 4 2 5 7 2 15 2 20-1 2-1 2-3-1-4" fill="none" stroke="#EA2D2E" strokeWidth="2.5" strokeLinecap="round" />
        <path d="M20 51c-3 2 0 4 3 5 8 2 17 1 21-2" fill="none" stroke="#EA2D2E" strokeWidth="2.5" strokeLinecap="round" />
      </svg>
    ),
    ...
    html: (
      <svg {...commonProps}>
        ...
        <path d="M32 10v45.3l16.1-4.5L51.6 10H32Z" fill="#F16529" />
        <path d="M32 27.6H19.9l.5 5.7H32v5.6H15.9l1.4 15.6L32 58.4v-5.9l-.1.1-9-2.5-.6-6.7h5.9l.3 3.3 3.5 1v-6H16.6l-1.6-17.7H32v5.6Z" fill="#EBEBEB" />
        <path d="M32 27.6h11.6l-.5 5.7H32v5.6h10.6l-1 11.6-9.6 2.7v6l14.8-4.1L48.4 32l.5-4.4.6-6.9H32v5.6Z" fill="#fff" />
      </svg>
    ),
    ...
    css: (
      <svg {...commonProps}>
        ...
        <path d="M32 10v45.3l16.1-4.5L51.6 10H32Z" fill="#1C88C7" />
        <path d="M32 27.6H19.7l.5 5.7H32v5.6H15.8l1.5 16.3 14.6 4.1.1-.1v-5.9l-.1.1-8-2.2-.5-5.8h5.9l.3 2.9 2.4.7v-6H16.7l-1.6-17.7H32v5.6Z" fill="#fff" />
        <path d="M32 27.6h11.9l-.5 5.7H32v5.6h10.9l-1 11.3-9.9 2.8v6l14.8-4.1 1.6-18.1.5-5.2.6-6.2H32v5.6Z" fill="#EBEBEB" />
      </svg>
    ),
    ...
    react: (
      <svg {...commonProps}>
        ...
        <g stroke="#61DAFB" strokeWidth="2.3" fill="none">
    ...
    go: (
      <svg {...commonProps}>
        ...
        <text x="32" y="41" textAnchor="middle" fontFamily="'Arial Black', Arial, sans-serif" fontWeight="900" fontSize="22" fill="#00ADD8" letterSpacing="-1">Go</text>
      </svg>
    ),
    ...
    rust: (
      <svg {...commonProps}>
        <rect x="2" y="2" width="60" height="60" rx="10" fill="#fff" stroke="#e5e7eb" strokeWidth="1" />
        <g fill="#000000">
          <circle cx="32" cy="32" r="16" fill="none" stroke="#000" strokeWidth="2.4" />
        </g>
        <text x="32" y="39" textAnchor="middle" fontFamily="Georgia, 'Times New Roman', serif" fontWeight="700" fontSize="17" fill="#000">R</text>
      </svg>
    ),
    ...
    // GitHub — dark bg, official Octocat silhouette
    github: (
      <svg {...commonProps}>
        <rect x="2" y="2" width="60" height="60" rx="10" fill="#181717" />
        <path
    ...
    sql: (
      <svg {...commonProps}>
        <rect x="2" y="2" width="60" height="60" rx="10" fill="#fff" stroke="#e5e7eb" strokeWidth="1" />
        <ellipse cx="32" cy="18" rx="16" ry="6" fill="#00618A" />
        <path d="M16 18v9c0 3.3 7.2 6 16 6s16-2.7 16-6v-9" fill="none" stroke="#00618A" strokeWidth="2.6" />
        <path d="M16 27v9c0 3.3 7.2 6 16 6s16-2.7 16-6v-9" fill="none" stroke="#00618A" strokeWidth="2.6" />
        <path d="M16 36v9c0 3.3 7.2 6 16 6s16-2.7 16-6v-9" fill="none" stroke="#00618A" strokeWidth="2.6" />
        <path d="M22 46c2 5 4 8 8 8" fill="none" stroke="#E48E00" strokeWidth="2.6" strokeLinecap="round" />
        <path d="M30 50c1 2 2 3 4 3" fill="none" stroke="#E48E00" strokeWidth="2.2" strokeLinecap="round" />
      </svg>
    ),
    ...
    php: (
      <svg {...commonProps}>
        ...
        <text x="32" y="38" textAnchor="middle" fontFamily="Georgia, serif" fontWeight="700" fontStyle="italic" fontSize="18" fill="#fff">php</text>
      </svg>
    ),
    ...
    ruby: (
      <svg {...commonProps}>
        ...
        <path d="M46 12 25 19l9 3 12-10Z" fill="#E0115F" />
        <path d="M18 17 9 34l16-13-7-4Z" fill="#E0115F" />
        <path d="M34 44 9 34l25 22 20-17-6-8-15 5-9-8Z" fill="#9B111E" />
      </svg>
    ),
    ...
    swift: (
      <svg {...commonProps}>
        ...
        <rect x="2" y="2" width="60" height="60" rx="14" fill="url(#swiftGrad)" />
        <path
    ...
    kotlin: (
      <svg {...commonProps}>
        ...
        <path d="M6 6h52L34 32l24 26H6l28-26L6 6Z" fill="url(#kotlinGrad)" />
      </svg>
    ),
  };
  ...
  return (
    icons[key] || (
      <svg {...commonProps}>
        ...
        <text x="32" y="41" textAnchor="middle" fontFamily="Arial, sans-serif" fontWeight="700" fontSize="24" fill="#fff">
